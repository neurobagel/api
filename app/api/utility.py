...
def fetch_and_save_cogatlas(output_path: Path):
    ...
    try:
        ...
        warnings.warn(
            f""""
            Fetching of the Cognitive Atlas task vocabulary from the source failed due to a network error.
            Will default to using a local backup copy of the vocabulary instead.
