...
def test_get_all(test_app, mock_successful_get_query, monkeypatch):
    ...
    monkeypatch.setattr(crud, "get", mock_successful_get_query)
    response = test_app.get("/query/")
...
def test_get_valid_age_single_bound(
    test_app, mock_successful_get_query, age_keyval, monkeypatch
):
...
def test_get_invalid_age(
    ...
    monkeypatch.setattr(crud, "get", mock_invalid_get_query)
    response = test_app.get(
...
def test_get_valid_sex(
    test_app, mock_successful_get_query, valid_sex, monkeypatch
):
...
def test_get_invalid_sex(test_app, mock_invalid_get_query, monkeypatch):
...
def test_get_valid_diagnosis(
    test_app, mock_successful_get_query, valid_diagnosis, monkeypatch
):
...
def test_get_invalid_diagnosis(
    test_app, mock_invalid_get_query, invalid_diagnosis, monkeypatch
):
...
def test_get_valid_iscontrol(
    test_app, mock_successful_get_query, valid_iscontrol, monkeypatch
):
...
def test_get_invalid_iscontrol(test_app, mock_invalid_get_query, monkeypatch):
...
def test_get_invalid_control_diagnosis_pair(
    test_app, mock_invalid_get_query, monkeypatch
):
...
def test_get_valid_min_num_sessions(
    test_app, mock_successful_get_query, valid_min_num_sessions, monkeypatch
):
...
def test_get_invalid_min_num_sessions(
    test_app, mock_invalid_get_query, invalid_min_num_sessions, monkeypatch
):
...
def test_get_valid_assessment(
    test_app, mock_successful_get_query, monkeypatch
):
...
def test_get_invalid_assessment(
    test_app, mock_invalid_get_query, invalid_assessment, monkeypatch
):
...
def test_get_invalid_image_modal(
    test_app, mock_invalid_get_query, invalid_image_modal, monkeypatch
):
